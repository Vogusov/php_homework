<?php
  ...
  */
  function resize($image, $w_o = false, $h_o = false) {
    ...
    return $func($img_o, "images-sm/".basename($image, ".".pathinfo($image)['extension'])."-sm.".$ext); // Сохраняем изображение с другим именем в ту же папку, возвращая результат этой операции
  }
