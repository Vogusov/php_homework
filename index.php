<?php
	...
	$a = 5;
	$b = '05';
	var_dump($a == $b);         // строка при сравнении приводится приводится к числу 5;
	var_dump((int)'012345');     // строка приводится к целому числу, 0 отбрасывается;
	var_dump((float)123.0 === (int)123.0); // float строго не равен int;
	var_dump((int)0 === (int)'hello, world'); // потому что эта строка не может быть приведена к целому числу, то возвращается false; false приводится к 0. 0===0; 
